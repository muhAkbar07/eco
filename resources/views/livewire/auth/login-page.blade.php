        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            ...
            <form wire:submit.prevent="save">
                @if (session('error'))
                    <div class="mt-2 bg-red-100 border border-red-200 text-sm text-red-800 rounded-lg p-4 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500" role="alert" style="background-color: #FEE2E2 !important; border-color: #d63434 !important; color: #7a0a0a !important;">
                        {{ session('error') }}
                    </div>
                @endif
                ...
                <div>
                  <label for="email" class="block text-sm mb-2 dark:text-white">Email address</label>
                    <div class="relative">
                        ...
                        @error('email')
                            <p class="text-xs text-red-600 flex mt-2" id="email-error">{{ $message }}
                            </p>
                        @enderror
                </div>
                <!-- End Form Group -->
